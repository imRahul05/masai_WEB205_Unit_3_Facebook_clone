...
//                         <a href="HomePage/sidebarPage/findFriend.html" id="friends"><i class="fa-solid fa-user-group"></i></a>
//                         <a href="HomePage/sidebarPage/videoPage/video.html" id="videos"><i class="fa-brands fa-youtube"></i></a>
//                         <a href="HomePage/sidebarPage/marketPlacePage/market.html" id="marketplace"><i class="fa-solid fa-store"></i></a>
//                         <a href="HomePage/sidebarPage/groupPage/group.html" id="groups"><i class="fa-solid fa-people-group"></i></a>
//                     </div>
//                     <div class="nav-right">
...
class NavigationBar extends HTMLElement {
    ...
    render() {
        ...
        this.shadowRoot.innerHTML = `
            <header>
                <nav>
                    <div class="nav-left">
                        <a href="${basePath}HomePage/Home.html"><img src="${basePath}HomePage/navbar/Logo.webp" alt="logo" /></a>
                        <input type="text" placeholder="Search..." />
                    </div>
                    <div class="nav-center">
                        <a href="${basePath}HomePage/Home.html" id="home"><i class="fa-solid fa-house"></i></a>
                        <a href="${basePath}HomePage/sidebarPage/findFriend.html" id="friends"><i class="fa-solid fa-user-group"></i></a>
                        <a href="${basePath}HomePage/sidebarPage/videoPage/video.html" id="videos"><i class="fa-brands fa-youtube"></i></a>
                        <a href="${basePath}HomePage/sidebarPage/marketPlacePage/market.html" id="marketplace"><i class="fa-solid fa-store"></i></a>
                        <a href="${basePath}HomePage/sidebarPage/groupPage/group.html" id="groups"><i class="fa-solid fa-people-group"></i></a>
                    </div>
                    <div class="nav-right">
                        <a href="${basePath}HomePage/message/message.html"><i class="fa-brands fa-facebook-messenger"></i></a>
                        <a href="${basePath}HomePage/notifications/notifications.html"><i class="fa-solid fa-bell"></i></a>
                        <a href="#"><img src="${user.profilePic}" alt="profile" class="profile-pic" /></a>
                        <div class="setting_menu">
                            <div class="settings_menu_inner">
                                <div class="user_profile">
                                    <i class="fa-solid fa-user"></i>
                                    <div class="user_info">
                                        <a href="${basePath}Profile/index.html">See Your Profile</a>
                                    </div>
                                </div>
                                <hr />
                                <div class="setting_link">
    ...
    getBasePath() {
        const scriptPath = new URL(this.baseURI).pathname;
        const depth = scriptPath.split('/').length - 3; // Adjust based on the depth of the nav.js file
        return '../'.repeat(depth);
    }
